...
DROP TABLE IF EXISTS `spell_display_effects`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `spell_display_effects` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `spell_id` int(10) unsigned NOT NULL DEFAULT 0,
  `tier` tinyint(3) unsigned NOT NULL DEFAULT 1,
  `percentage` tinyint(3) unsigned DEFAULT 100,
...
) ENGINE=InnoDB AUTO_INCREMENT=165118 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
