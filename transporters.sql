...
CREATE TABLE `transporters` (
  ...
  `transport_type` enum('Zone','Location','Generic Transport') COLLATE latin1_general_ci NOT NULL DEFAULT 'Zone',
...
) ENGINE=InnoDB AUTO_INCREMENT=137 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC;
